...
#    opcionales: API_URL (default 127.0.0.1:8000), WEB_URL (IP tablet),
#    RTJPN_ROI (x,y,w,h inicial)
# 3. python telegram_bot.py  (Fase 6: systemd jpn-bot.service)
# Flujo: foto -> "📤 Enviada…" -> POST al server -> "✅ Traducida [backend ms]"
# /roi x,y,w,h ajusta recorte remoto — /roi off lo quita.
# /modo tesseract|rapidocr|groq cambia el motor OCR por chat.
